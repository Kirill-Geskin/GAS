...
void AGASCharacter::InitializeAttributes()
{
	...
	{
		// FGameplayEffectContextHandle have information about the context in which we are applying effect
...
void AGASCharacter::GiveAbilities()
{
	...
	{
		//loop over those default abilities
		for (TSubclassOf<UGASGameplayAbility>& StartupAbility : DefaultAbilities)
		{
			//giving to the player default abilities
...
void AGASCharacter::PossessedBy(AController* NewController)
{
	...
	//Server GAS init. Telling who the owner of the ability component
